...
<section class="eng-services">
	<div class="container">
		...
		<h1>Инженерно-экологические изыскания для проектирования и экспертизы</h1>
		<p class="eng-services__subtitle">Экологические изыскания с подготовкой данных для проектной документации и прохождения экспертизы.</p>
	...
	<div class="eng-services__sidebar">
            <div class="eng-services__features">
                <ul class="eng-services__features-list">
                    <li class="eng-services__features-item">Оценка состояния окружающей среды</li>
                    <li class="eng-services__features-item">Отбор и анализ проб</li>
                    <li class="eng-services__features-item">Подготовка отчетной документации</li>
        ...
        <div class="eng-services__slider">
            ...
            <div class="eng-services__track" id="engServicesTrack">
                <div class="eng-services__slide">
                    <img src="/wp-content/uploads/2026/06/gl_slide_ekologiya.webp" alt="Инженерно-экологические изыскания" class="eng-services__slide-bg" fetchpriority="high">
                </div>
            </div>
            ...
            <div class="eng-services__overlay">
                <div class="eng-services__info-wrap">
                    <div class="eng-services__info eng-services__info--active">
                       ...
                       <p class="eng-services__info-desc">Организуем экологические изыскания в составе комплексных работ.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="base-prep__grid">
            <div class="benefits__image-wrap consequencesimg">
                ...
                <img src="/wp-content/uploads/2026/06/task-ekologiya.webp" alt="Задача экологических изысканий" class="benefits__image">
            </div>

            <div class="base-prep__content">
                <h2 class="base-prep__title">Задача экологических изысканий</h2>
                

                <div class="benefits__block">
                    <h3 class="benefits__block-title">Экологические изыскания необходимы для:</h3>
                    <ul class="benefits__list">
                        <li>оценки текущего состояния территории</li>
                        <li>определения ограничений для проектирования</li>
                        <li>подготовки разделов проектной документации</li>
                        <li>прохождения экспертизы</li>
                    </ul>
                </div>

                <div class="base-prep__alert">
                    <div class="base-prep__alert-icon"><svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.77728 34.4453H2.55469C2.0024 34.4453 1.55469 33.9976 1.55469 33.4453V26.2227M26.2225 34.4453H33.4451C33.9973 34.4453 34.4451 33.9976 34.4451 33.4453V26.2227M34.4451 9.77752V2.55493C34.4451 2.00265 33.9973 1.55493 33.4451 1.55493H26.2225M9.77728 1.55493H2.55469C2.0024 1.55493 1.55469 2.00265 1.55469 2.55493V9.77752" stroke="#fff" stroke-width="0.6"></path><g clip-path="url(#clip0_304_3817)"><path d="M27 17.6084C27 19.3884 26.4722 21.1285 25.4832 22.6085C24.4943 24.0886 23.0887 25.2421 21.4442 25.9233C19.7996 26.6045 17.99 26.7827 16.2442 26.4355C14.4984 26.0882 12.8947 25.231 11.636 23.9724C10.3774 22.7137 9.5202 21.11 9.17294 19.3642C8.82567 17.6184 9.0039 15.8088 9.68509 14.1642C10.3663 12.5197 11.5198 11.1141 12.9999 10.1252C14.4799 9.13624 16.22 8.6084 18 8.6084C20.3862 8.61098 22.6738 9.56002 24.3611 11.2473C26.0484 12.9346 26.9974 15.2222 27 17.6084ZM18.75 12.3584H17.25V19.8584H18.75V12.3584ZM18.75 21.3584H17.25V22.8584H18.75V21.3584Z" fill="#F26522"></path></g><defs><clipPath id="clip0_304_3817"><rect width="18" height="18" fill="white" transform="translate(9 8.6084)"></rect></clipPath></defs></svg></div>
                    <p class="base-prep__alert-text">Отсутствие или ошибки в данных приводят к: замечаниям экспертизы, доработкам проекта, задержкам сроков.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="applications">
    <div class="container applications__container">
        <div class="applications__sidebar">
            ...
            <p class="applications__subtitle">Состав определяется ТЗ и требованиями проекта.</p>
                ...
                <div class="applications__slide">
                    <div class="applications__card">
                        <div class="applications__card-img-wrap">
                            <img src="/wp-content/uploads/2026/06/ekologiya_otbor-e1782240648857.webp" alt="Отбор проб грунта, воды, воздуха" class="applications__card-img">
                        </div>
                        <div class="applications__card-meta">[01]</div>
                        <h3 class="title_18_600">Отбор проб грунта, воды, воздуха</h3>
                    </div>
                </div>
                <div class="applications__slide">
                    <div class="applications__card">
                        <div class="applications__card-img-wrap">
                            <img src="/wp-content/uploads/2026/06/ekologiya_lab.webp" alt="Лабораторные исследования" class="applications__card-img">
                        </div>
                        <div class="applications__card-meta">[02]</div>
                        <h3 class="title_18_600">Лабораторные исследования</h3>
                    </div>
                </div>
                <div class="applications__slide">
                    <div class="applications__card">
                        <div class="applications__card-img-wrap">
                            <img src="/wp-content/uploads/2026/06/ekologiya_analiz.webp" alt="Анализ загрязнений" class="applications__card-img">
                        </div>
                        <div class="applications__card-meta">[03]</div>
                        <h3 class="title_18_600">Анализ загрязнений</h3>
                    </div>
                </div>
                <div class="applications__slide">
                    <div class="applications__card">
                        <div class="applications__card-img-wrap">
                            <img src="/wp-content/uploads/2026/06/ekologiya_otsenka.webp" alt="Оценка воздействия" class="applications__card-img">
                        </div>
                        <div class="applications__card-meta">[04]</div>
                        <h3 class="title_18_600">Оценка воздействия</h3>
                    </div>
                </div>
                <div class="applications__slide">
                    <div class="applications__card">
                        <div class="applications__card-img-wrap">
                            <img src="/wp-content/uploads/2026/06/ekologiya_kameral.webp" alt="Камеральная обработка" class="applications__card-img">
                        </div>
...
<section class="benefits">
    <div class="container">
        <div class="benefits__grid">
            <div class="benefits__image-wrap consequencesimg">
                <div class="benefits__corners"><div class="benefits__corners-inner"></div></div>
                <img src="/wp-content/uploads/2026/06/results-ekologiya.webp" alt="Результат работ" class="benefits__image">
            </div>
            ...
            <div class="benefits__content">
                ...
                <div class="benefits__block">
                    ...
                    <ul class="benefits__list">
                        <li>отчет по инженерно-экологическим изысканиям</li>
                        <li>результаты лабораторных исследований</li>
                        <li>исходные данные для проектирования</li>
                        <li>материалы для разделов проектной документации</li>
                    </ul>
                </div>

                <p class="benefits__subtitle">Документация подготавливается под требования экспертизы.</p>

                <div class="benefits__block">
                    <h3 class="benefits__block-title">Комплексная организация экологических изысканий</h3>
                    <p>Берём на себя организацию полного цикла.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="timelines__grid">
            <div class="timelines__card">
                ...
                <ul class="timelines__list">
                    <li>полевые работы — 3–7 дней</li>
                    <li>лаборатория и отчеты — 7–20 дней</li>
                </ul>
            ...
            <div class="timelines__card">
                ...
                <ul class="timelines__list">
                    <li>состава работ</li>
                    <li>объема проб</li>
                    <li>требований проекта</li>
                </ul>
				<img src="/wp-content/uploads/2026/07/icon-1.webp" alt="les" class="timelines__grid-absolute">
            </div>
        </div>
    </div>
</section>

<section class="process" style="background-color: #000000B2;background-image:url(/wp-content/uploads/2026/06/bg-main-shag-ekologiya.webp)">
    <div class="container">
        ...
        <div class="process__steps">
            ...
            <div class="process__step">
                ...
                <div class="process__content"><p class="process__name">Определение состава изысканий</p></div>
            </div>
            <div class="process__step">
        ...
        <div class="regulatory__grid">
            <div class="regulatory__content">
                ...
                <ul class="regulatory__list">
                    ...
                    <li>Привлекаются аккредитованные лаборатории</li>
                </ul>
            </div>
    ...
    <div class="container">
        <div class="">
            <div class="cost-section__info">
                <h2 class="cost-section__title">Стоимость экологических изысканий</h2>
                ...
                <ul class="cost-section__list">
					...
					<li>категория объекта</li> 
					<li>состав исследований</li> 
					<li>объём полевых работ</li> 
...
<section class="faq-v2">
    <div class="container">
        <div class="faq-v2__inner" style="background-image: linear-gradient(rgba(45, 50, 59, 0.8), rgba(45, 50, 59, 0.8)), url('/wp-content/uploads/2026/06/faqekologiya.webp');">
...
<section class="cta notopadding mgtop-15" id="discuss">
    ...
    <div class="container">
        <div class="cta__inner">
            <div class="cta__text">
                <h2 class="cta__title">Передайте ТЗ<br>на экологические изыскания</h2>
